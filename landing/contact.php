...
<head>
    <meta charset="UTF-8">
    <meta name="description" content="Uzaktan Canlı Destek">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">

    <title>Ucd - Uzaktan Canlı Destek</title>
                    ...
                    <div class="classy-menu">
                        ...
                        <div class="classynav">
                            ...
                            <div class="get-a-quote ml-4 mr-3">
                                <a href="#" class="btn uza-btn">Tanıtım Videosu</a>
                            </div>
                            ...
                            <div class="login-register-btn mx-3">
                                <a href="./register.html">Kayıt Ol</span></a>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <input type="text" class="form-control mb-30" name="full-name" placeholder="İsim">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <input type="text" class="form-control mb-30" name="full-name" placeholder="Soyisim">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <input type="password" class="form-control mb-30" name="full-name" placeholder="Şifre">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <input type="password" class="form-control mb-30" name="full-name" placeholder="Şifre Tekrar">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <input type="text" class="form-control mb-30" name="full-name" placeholder="Telefon">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <input type="text" class="form-control mb-30" name="email" placeholder="Firma Adı">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <input type="text" class="form-control mb-30" name="email" placeholder="Ürün Adı">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <button class="btn uza-btn btn-3 mt-15">Kayıt Ol</button>
                                </div>
                            </div>
                        </form>
                    </div>
