<?php include 'header.php'; ?>
    ...
    <script src="<?=BASE_URL?>/admin-panel/vendors/bootstrap-progressbar/bootstrap-progressbar.min.js"></script>
    <!-- iCheck -->
    <script src="<?=BASE_URL?>/admin-panel/vendors/iCheck/icheck.min.js"></script>
    <!-- bootstrap-daterangepicker -->
    <script src="<?=BASE_URL?>/admin-panel/vendors/moment/min/moment.min.js"></script>
    <script src="<?=BASE_URL?>/admin-panel/vendors/bootstrap-daterangepicker/daterangepicker.js"></script>
    <!-- bootstrap-wysiwyg -->
    <script src="<?=BASE_URL?>/admin-panel/vendors/bootstrap-wysiwyg/js/bootstrap-wysiwyg.min.js"></script>
    <script src="<?=BASE_URL?>/admin-panel/vendors/jquery.hotkeys/jquery.hotkeys.js"></script>
    <script src="<?=BASE_URL?>/admin-panel/vendors/google-code-prettify/src/prettify.js"></script>
    <!-- jQuery Tags Input -->
    <script src="<?=BASE_URL?>/admin-panel/vendors/jquery.tagsinput/src/jquery.tagsinput.js"></script>
    <!-- Switchery -->
    <script src="<?=BASE_URL?>/admin-panel/vendors/switchery/dist/switchery.min.js"></script>
    <!-- Select2 -->
    <script src="<?=BASE_URL?>/admin-panel/vendors/select2/dist/js/select2.full.min.js"></script>
    <!-- Parsley -->
    <script src="<?=BASE_URL?>/admin-panel/vendors/parsleyjs/dist/parsley.min.js"></script>
    <!-- Autosize -->
    <script src="<?=BASE_URL?>/admin-panel/vendors/autosize/dist/autosize.min.js"></script>
    <!-- jQuery autocomplete -->
    <script src="<?=BASE_URL?>/admin-panel/vendors/devbridge-autocomplete/dist/jquery.autocomplete.min.js"></script>
    <!-- starrr -->
    <script src="<?=BASE_URL?>/admin-panel/vendors/starrr/dist/starrr.js"></script>
